package br.com.redhat.amq.streams.exemplo2.producer;
...
public class RecebimentoPedidosApplication {
  ...
  public void registraNovoEvento() {
    NovoPedidoRecebidoEvent evento = new NovoPedidoRecebidoEvent(1, "Carlos Alberto");

    System.out.printf("Disparando evento: %s\n", evento);
    kafkaTemplate().send("evento-novo-pedido-recebido", evento);
  }
